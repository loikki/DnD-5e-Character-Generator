...
def setupEquipment(self):
    ...
    self.tab6_tab0_owned_tree.setSortingEnabled(True)
    ...
    self.tab6_tab1_owned_tree.setSortingEnabled(True)
    ...
    self.tab6_tab2_list_tree.setSortingEnabled(True)
    ...
    self.tab6_tab2_owned_tree.setSortingEnabled(True)
