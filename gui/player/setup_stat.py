...
def setupStat(self):
    ...
    # trait
    self.tab8_trait_layout = QtGui.QGroupBox("Trait", self.tab8_right_layout)
    self.tab8_trait_layout.setObjectName(_fromUtf8("tab8_trait_layout"))
    self.verticalLayout_28 = QtGui.QVBoxLayout(self.tab8_trait_layout)
    self.verticalLayout_28.setObjectName(_fromUtf8("verticalLayout_28"))
    self.tab8_trait_tree = QtGui.QTreeWidget(self.tab8_trait_layout)
    self.tab8_trait_tree.setObjectName(_fromUtf8("tab8_trait_tree"))
    item_0 = QtGui.QTreeWidgetItem(self.tab8_trait_tree)
    self.tab8_trait_tree.headerItem().setText(0, "Name")
    self.tab8_trait_tree.headerItem().setText(1, "Max uses")
    __sortingEnabled = self.tab8_trait_tree.isSortingEnabled()
    self.tab8_trait_tree.setSortingEnabled(False)
    self.tab8_trait_tree.topLevelItem(0).setText(0, "Actor")
    self.tab8_trait_tree.topLevelItem(0).setText(1, "Unlimited")
    self.tab8_trait_tree.setSortingEnabled(__sortingEnabled)
    self.verticalLayout_28.addWidget(self.tab8_trait_tree)
    self.verticalLayout_16.addWidget(self.tab8_trait_layout)
    # spell
    ...
    self.tab8_spell_tree.setSortingEnabled(True)
